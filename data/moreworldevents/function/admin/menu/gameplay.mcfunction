...
scoreboard players operation #display_hours mwe.event_timer = #mwe.event_timer/start mwe.event_timer
scoreboard players set #3600 mwe.event_timer 3600
scoreboard players operation #display_hours mwe.event_timer /= #3600 mwe.event_timer

scoreboard players operation #display_mins mwe.event_timer = #mwe.event_timer/start mwe.event_timer
scoreboard players operation #display_mins mwe.event_timer %= #3600 mwe.event_timer
...
tellraw @s [{"text":"  Event Timer: ","color":"gray"},{"score":{"name":"#display_hours","objective":"mwe.event_timer"},"color":"white"},{"text":"h ","color":"white"},{"score":{"name":"#display_mins","objective":"mwe.event_timer"},"color":"white"},{"text":"m ","color":"white"},{"score":{"name":"#display_secs","objective":"mwe.event_timer"},"color":"white"},{"text":"s","color":"white"}]
tellraw @s ""
tellraw @s [{"text":"  Hours: ","color":"gray"},{"text":"[▲]","color":"green","click_event":{"action":"run_command","command":"/trigger mwe.admin.trigger set 14"},"hover_event":{"action":"show_text","value":"Increase hours"}},{"text":" ","color":"white"},{"text":"[▼]","color":"red","click_event":{"action":"run_command","command":"/trigger mwe.admin.trigger set 15"},"hover_event":{"action":"show_text","value":"Decrease hours"}}]
tellraw @s ""
