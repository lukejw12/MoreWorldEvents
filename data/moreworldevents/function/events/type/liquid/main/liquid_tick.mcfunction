...
execute if score #mwe.event_type/sub mwe.event_type matches 2 if predicate moreworldevents:events/type/sky/sky_exposure run damage @s 2 moreworldevents:acidic_rain1