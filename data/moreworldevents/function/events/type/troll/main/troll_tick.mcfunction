...
execute if score #mwe.event_type/sub mwe.event_type matches 3 if score #shuffle_timer mwe.temp matches 1000.. run function moreworldevents:events/type/troll/sub/inventory_shuffle
