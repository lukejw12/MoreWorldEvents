...
execute if score #mwe.event_type/previous mwe.event_type matches 8 if score #mwe.event_type/sub-previous mwe.event_type = #mwe.event_type/sub mwe.event_type run return run function moreworldevents:events/type/meteor/main/meteor_main
