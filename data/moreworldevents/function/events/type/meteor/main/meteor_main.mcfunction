...
execute unless entity @e[tag=mwe.options,tag=disable_meteor_4] run scoreboard players add #valid_count mwe.temp 1
...
execute store result score #random_pick mwe.temp run random value 1..4
...
execute unless entity @e[tag=mwe.options,tag=disable_meteor_4] run scoreboard players add #current_count mwe.temp 1
execute unless entity @e[tag=mwe.options,tag=disable_meteor_4] if score #current_count mwe.temp = #random_pick mwe.temp run scoreboard players set #mwe.event_type/sub mwe.event_type 4
...
execute if score #mwe.event_type/sub mwe.event_type matches 4 run scoreboard players set #meteor_countdown mwe.meteor_timer 10
