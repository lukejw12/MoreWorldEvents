execute if score #mwe.event_storage/random mwe.event_storage matches 2 as @a at @s run function moreworldevents:events/type/mine/main/mine_tick
execute if score #mwe.event_storage/random mwe.event_storage matches 4 as @a at @s run function moreworldevents:events/type/liquid/main/liquid_tick
