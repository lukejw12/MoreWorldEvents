...
# NORMAL Task 1002: Kill mobs
execute if score @s mwe.token.task matches 1002 run tellraw @s [{"text":"     NORMAL CHALLENGE ACCEPTED","color":"green","bold":true}]
...
# NORMAL Task 1003: Travel distance
execute if score @s mwe.token.task matches 1003 run tellraw @s [{"text":"     NORMAL CHALLENGE ACCEPTED","color":"green","bold":true}]
...
# NORMAL Task 1004: Collect farmable
execute if score @s mwe.token.task matches 1004 run tellraw @s [{"text":"     NORMAL CHALLENGE ACCEPTED","color":"green","bold":true}]
...
execute if score @s mwe.token.task matches 1004 if score @s mwe.token.farmable matches 1 run tellraw @s [{"text":"Task: Collect 64 Wheat","color":"white"}]
execute if score @s mwe.token.task matches 1004 if score @s mwe.token.farmable matches 2 run tellraw @s [{"text":"Task: Collect 64 Carrots","color":"white"}]
execute if score @s mwe.token.task matches 1004 if score @s mwe.token.farmable matches 3 run tellraw @s [{"text":"Task: Collect 64 Potatoes","color":"white"}]
execute if score @s mwe.token.task matches 1004 if score @s mwe.token.farmable matches 4 run tellraw @s [{"text":"Task: Collect 64 Iron Ingots","color":"white"}]
execute if score @s mwe.token.task matches 1004 if score @s mwe.token.farmable matches 5 run tellraw @s [{"text":"Task: Collect 64 Coal","color":"white"}]
...
# NORMAL Task 1005: Deal damage
execute if score @s mwe.token.task matches 1005 run tellraw @s [{"text":"     NORMAL CHALLENGE ACCEPTED","color":"green","bold":true}]
...
# NORMAL Task 1006: Fish items
execute if score @s mwe.token.task matches 1006 run tellraw @s [{"text":"     NORMAL CHALLENGE ACCEPTED","color":"green","bold":true}]
...
# NORMAL Task 1007: Breed animals
execute if score @s mwe.token.task matches 1007 run tellraw @s [{"text":"     NORMAL CHALLENGE ACCEPTED","color":"green","bold":true}]
...
# NORMAL Task 1008: Trade with villagers
execute if score @s mwe.token.task matches 1008 run tellraw @s [{"text":"     NORMAL CHALLENGE ACCEPTED","color":"green","bold":true}]
...
# NORMAL Task 1009: Gain levels
execute if score @s mwe.token.task matches 1009 run tellraw @s [{"text":"     NORMAL CHALLENGE ACCEPTED","color":"green","bold":true}]
...
# HARD Task 2001: Kill boss
execute if score @s mwe.token.task matches 2001 run tellraw @s [{"text":"     HARD CHALLENGE ACCEPTED","color":"gold","bold":true}]
...
execute if score @s mwe.token.task matches 2001 if score @s mwe.token.farmable matches 1 run tellraw @s [{"text":"Task: Kill an Elder Guardian","color":"white"}]
execute if score @s mwe.token.task matches 2001 if score @s mwe.token.farmable matches 2 run tellraw @s [{"text":"Task: Kill the Wither","color":"white"}]
execute if score @s mwe.token.task matches 2001 if score @s mwe.token.farmable matches 3 run tellraw @s [{"text":"Task: Kill the Ender Dragon","color":"white"}]
execute if score @s mwe.token.task matches 2001 if score @s mwe.token.farmable matches 4 run tellraw @s [{"text":"Task: Kill a Warden","color":"white"}]
...
# HARD Task 2002: Obtain rare item
execute if score @s mwe.token.task matches 2002 run tellraw @s [{"text":"     HARD CHALLENGE ACCEPTED","color":"gold","bold":true}]
...
execute if score @s mwe.token.task matches 2002 if score @s mwe.token.farmable matches 1 run tellraw @s [{"text":"Task: Obtain a Nether Star","color":"white"}]
execute if score @s mwe.token.task matches 2002 if score @s mwe.token.farmable matches 2 run tellraw @s [{"text":"Task: Obtain a Heavy Core","color":"white"}]
execute if score @s mwe.token.task matches 2002 if score @s mwe.token.farmable matches 3 run tellraw @s [{"text":"Task: Obtain an Elytra","color":"white"}]
execute if score @s mwe.token.task matches 2002 if score @s mwe.token.farmable matches 4 run tellraw @s [{"text":"Task: Obtain a Trident","color":"white"}]
execute if score @s mwe.token.task matches 2002 if score @s mwe.token.farmable matches 5 run tellraw @s [{"text":"Task: Obtain an Enchanted Golden Apple","color":"white"}]
...
# HARD Task 2003: Reach End
execute if score @s mwe.token.task matches 2003 run tellraw @s [{"text":"     HARD CHALLENGE ACCEPTED","color":"gold","bold":true}]
...
# HARD Task 2004: Reach Nether
execute if score @s mwe.token.task matches 2004 run tellraw @s [{"text":"     HARD CHALLENGE ACCEPTED","color":"gold","bold":true}]
...
# HARD Task 2005: Find structure
execute if score @s mwe.token.task matches 2005 run tellraw @s [{"text":"     HARD CHALLENGE ACCEPTED","color":"gold","bold":true}]
...
execute if score @s mwe.token.task matches 2005 if score @s mwe.token.farmable matches 1 run tellraw @s [{"text":"Task: Find and Enter a Stronghold","color":"white"}]
execute if score @s mwe.token.task matches 2005 if score @s mwe.token.farmable matches 2 run tellraw @s [{"text":"Task: Find and Enter a Bastion Remnant","color":"white"}]
execute if score @s mwe.token.task matches 2005 if score @s mwe.token.farmable matches 3 run tellraw @s [{"text":"Task: Find and Enter an End City","color":"white"}]
execute if score @s mwe.token.task matches 2005 if score @s mwe.token.farmable matches 4 run tellraw @s [{"text":"Task: Find and Enter an Ancient City","color":"white"}]
...
# HARD Task 2006: Enchant item
execute if score @s mwe.token.task matches 2006 run tellraw @s [{"text":"     HARD CHALLENGE ACCEPTED","color":"gold","bold":true}]
...
# HARD Task 2007: Brew lingering potion
execute if score @s mwe.token.task matches 2007 run tellraw @s [{"text":"     HARD CHALLENGE ACCEPTED","color":"gold","bold":true}]
...
# HARD Task 2008: Obtain max book
execute if score @s mwe.token.task matches 2008 run tellraw @s [{"text":"     HARD CHALLENGE ACCEPTED","color":"gold","bold":true}]
...
# CHALLENGE Task 3001: Kill 2 bosses
execute if score @s mwe.token.task matches 3001 run tellraw @s [{"text":"     CHALLENGE ACCEPTED","color":"light_purple","bold":true}]
...
# CHALLENGE Task 3002: Obtain 3 rare items
execute if score @s mwe.token.task matches 3002 run tellraw @s [{"text":"     CHALLENGE ACCEPTED","color":"light_purple","bold":true}]
...
# CHALLENGE Task 3003: Collect all Netherite types
execute if score @s mwe.token.task matches 3003 run tellraw @s [{"text":"     CHALLENGE ACCEPTED","color":"light_purple","bold":true}]
...
# CHALLENGE Task 3004: Collect all log types
execute if score @s mwe.token.task matches 3004 run tellraw @s [{"text":"     CHALLENGE ACCEPTED","color":"light_purple","bold":true}]
...
# CHALLENGE Task 3005: Collect all hostile mob drops
execute if score @s mwe.token.task matches 3005 run tellraw @s [{"text":"     CHALLENGE ACCEPTED","color":"light_purple","bold":true}]
...
# CHALLENGE Task 3006: Collect all music discs
execute if score @s mwe.token.task matches 3006 run tellraw @s [{"text":"     CHALLENGE ACCEPTED","color":"light_purple","bold":true}]
...
# CHALLENGE Task 3007: Collect all armor trims
execute if score @s mwe.token.task matches 3007 run tellraw @s [{"text":"     CHALLENGE ACCEPTED","color":"light_purple","bold":true}]
...
# CHALLENGE Task 3008: Collect all goat horns
execute if score @s mwe.token.task matches 3008 run tellraw @s [{"text":"     CHALLENGE ACCEPTED","color":"light_purple","bold":true}]
...
# CHALLENGE Task 3009: Obtain Netherite Block
execute if score @s mwe.token.task matches 3009 run tellraw @s [{"text":"     CHALLENGE ACCEPTED","color":"light_purple","bold":true}]
...
# CHALLENGE Task 3010: Collect all flowers
execute if score @s mwe.token.task matches 3010 run tellraw @s [{"text":"     CHALLENGE ACCEPTED","color":"light_purple","bold":true}]
