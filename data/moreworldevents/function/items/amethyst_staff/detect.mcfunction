...
execute unless items entity @s weapon.mainhand test_block[custom_data~{mwe.ray:1b}] run return fail
...
execute if predicate moreworldevents:items/is_sneaking if items entity @s weapon.offhand minecraft:test_block run return run function moreworldevents:items/amethyst_staff/charge
