...
execute if predicate moreworldevents:items/is_sneaking if items entity @s weapon.offhand minecraft:test_instance_block[custom_data~{"mwe.amethyst_core":1b}] run return run function moreworldevents:items/amethyst_staff/charge
