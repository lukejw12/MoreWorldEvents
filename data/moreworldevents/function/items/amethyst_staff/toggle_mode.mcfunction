...
execute if data storage mwe:staff {mode:"shrink"} run title @s subtitle {"text":"Mode: Grow","color":"#4404f9","shadow_color":0}
execute if data storage mwe:staff {mode:"grow"} run title @s title ""
execute if data storage mwe:staff {mode:"grow"} run title @s subtitle {"text":"Mode: Shrink","color":"#4404f9","shadow_color":0}
data modify storage mwe:staff mode set from entity @s SelectedItem.components."minecraft:custom_data".mode
