execute store result score #cx mwe.temp run data get entity @s Pos[0] 1000
execute store result score #cy mwe.temp run data get entity @s Pos[1] 1000
execute store result score #cz mwe.temp run data get entity @s Pos[2] 1000

scoreboard players operation #dx mwe.temp = #marker_x mwe.temp
scoreboard players operation #dy mwe.temp = #marker_y mwe.temp
scoreboard players operation #dz mwe.temp = #marker_z mwe.temp
