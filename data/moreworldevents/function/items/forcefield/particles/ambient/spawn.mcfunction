...
function moreworldevents:items/forcefield/particles/ambient/place_particle with storage mwe:temp

execute if score @s mwe.ff.radius matches 20.. run function moreworldevents:items/forcefield/particles/ambient/spawn_extra
execute if score @s mwe.ff.radius matches 25.. run function moreworldevents:items/forcefield/particles/ambient/spawn_extra
execute if score @s mwe.ff.radius matches 30.. run function moreworldevents:items/forcefield/particles/ambient/spawn_extra
execute if score @s mwe.ff.radius matches 35.. run function moreworldevents:items/forcefield/particles/ambient/spawn_extra
execute if score @s mwe.ff.radius matches 40.. run function moreworldevents:items/forcefield/particles/ambient/spawn_extra