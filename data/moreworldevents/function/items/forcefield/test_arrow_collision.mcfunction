...
execute if score #current_dist_sq mwe.temp >= #radius_sq mwe.temp if score #next_dist_sq mwe.temp < #radius_sq mwe.temp run function moreworldevents:items/forcefield/reflect_on_crossing