...
$execute if data block ~ ~ ~ Items[{Slot:$(slot)b}] unless data block ~ ~ ~ Items[{Slot:$(slot)b,components:{"minecraft:custom_data":{$(tag):1b}}}] run function moreworldevents:items/forcefield/gui/util/eject_slot {slot:$(slot)}
