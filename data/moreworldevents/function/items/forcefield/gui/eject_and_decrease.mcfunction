# Store and eject item
data modify storage mwe:forcefield temp_item set from block ~ ~ ~ Items[{Slot:16b}]
...
# Now decrease range
function moreworldevents:items/forcefield/gui/decrease_range