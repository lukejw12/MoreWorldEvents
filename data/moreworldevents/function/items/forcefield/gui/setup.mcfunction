...
item replace block ~ ~ ~ container.9 with minecraft:barrier[tooltip_display={hide_tooltip:true},item_model="moreworldevents:gui/parts/blocked_slot",minecraft:item_name={"text":""},minecraft:custom_data={mwe.gui_item:1b}]
