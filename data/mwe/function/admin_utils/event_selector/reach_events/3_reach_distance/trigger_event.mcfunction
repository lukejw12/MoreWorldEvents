...
execute if score $reach reach matches 2 as @a[tag=reach] run attribute @s minecraft:entity_interaction_range base set 15
execute if score $reach reach matches 2 as @a[tag=reach] run attribute @s minecraft:block_interaction_range base set 15
execute as @a at @s run tellraw @s [{"text":"--------------","color":"dark_gray"}]
execute as @a at @s run tellraw @s [{"text":"New Event!","color":"aqua"}]
execute as @a at @s run tellraw @s [{"text":"3x Reach Distance!","color":"gold"}]
execute as @a at @s run tellraw @s [{"text":"--------------","color":"dark_gray"}]
playsound minecraft:entity.arrow.hit_player master @a ~ ~ ~ 1 0.1 1
tellraw @s [{"text":"Event Triggered","color":"dark_gray"}]
scoreboard players set $reach reach 4
